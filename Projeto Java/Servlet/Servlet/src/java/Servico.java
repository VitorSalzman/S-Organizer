...
public class Servico extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Servico</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Servico at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//            ServicoJpaController sjc = new ServicoJpaController();
            ...
            List<persistencia.Bairro> lista = jpa.findBairroEntities();
             
             for (persistencia.Bairro b : lista){
             out.println("Cod.: "+b.getId()+" Nome.:"+b.getNome());
            }
